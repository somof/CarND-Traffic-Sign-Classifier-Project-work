...
# (V-mean)/2xstdv epoch 60 -> 0.946 (middle)
...
def LeNet(x):
    ...
    with tf.name_scope('conv2'):
        ...
        # conv2 = tf.nn.conv2d(conv1, conv2_w, strides=[1, 1, 1, 1], padding='VALID', use_cudnn_on_gpu=False) + conv2_b
...
# report use functions
# import graph_build.py


# ## Train the Model

boarddir = 'log'
last_validation_accuracy = 0.96

with tf.Session() as sess:

    # erase Tensorboard logdir
